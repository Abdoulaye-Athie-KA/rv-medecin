    ...
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            <h5 class="card-title text-center">Ajouter specialite</h5>
            ...
            <?php
             ...
             ?>
              ...
              <div class="form-label-group">
                <?= $form->input('text','specialite','Nom specialite','');?>
              </div>
                ...
                $specialite = $_POST['specialite']; 
                 ...
                 $cle='nom_specialite';
                             ...
                             }elseif (!preg_match("/^[a-zA-Z]+$/",$specialite))//le nom s'écrive en lettre seulement
                             {
                              ...
                              $add = new Requette();
                               $res =  $add->insert($nomtable, $cle, $specialite);
                                     echo "ajoue specialite réussit"; 
                             }
