  ...
  <tbody>
    ...
    <?php 
      ...
      foreach ($res as $value) {
        echo "<tr>";
        echo  "<td>".$value['id_service']."</td>";
        echo  "<td>".$value['nom_service']."</td>";
        echo "<td><a class=\"edit\" href=\"modifierservice.php?id_service=$value[id_service]\">Modifier</a> | <a class=\"edit\" href=\"supprimerservice.php?id_service=$value[id_service]\">Supprimer</a> </td>";
        echo "</tr>";
      }
    ?>
