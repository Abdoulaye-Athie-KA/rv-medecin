...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="../../css/listerservice.css">
</head>
  ...
  <tbody>
    ...
    <?php 
      ...
      foreach ($res as $value) {
        echo "<tr>";
        echo  "<td>".$value['id_specialite']."</td>";
        echo  "<td>".$value['nom_specialite']."</td>";
        echo "<td><a class=\"edit\" href=\"modifierspecialite.php?id_specialite=$value[id_specialite]\">Modifier</a> | <a class=\"edit\" href=\"supprimerspecialite.php?id_specialite=$value[id_specialite]\">Supprimer</a> </td>";
        echo "</tr>";
      }
    ?>
