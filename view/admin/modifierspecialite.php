...
$sql="SELECT * FROM specialite WHERE id_specialite = $id";
$res = $bdd->query($sql);
$ligne = $res->fetch();
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="ajouspecialite.php">Ajouter Service</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="listerspecialite.php">Lister Service</a>
          </li>
          <li class="nav-item">
    ...
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            <h5 class="card-title text-center">Modifier specialite</h5>
            ...
            <?php
             ...
             ?>
              ...
              <div class="form-label-group">
                <?= $form->input('text','specialite','Nom Specialite', $ligne['nom_specialite']);?>
              </div>
              ...
              if(isset($_POST['submit'])){  
                $specialite = $_POST['specialite']; 
                 ...
                 $cle='nom_specialite';
                             ...
                             }elseif (!preg_match("/^[a-zA-Z]+$/",$specialite))//le nom s'écrive en lettre seulement
                             {
                                 echo "veuillez entrer un nom valide svp!";
                             }else{
                                global $bdd;
                                $sql = "UPDATE specialite SET nom_specialite = '$specialite' WHERE id_specialite = $id";
                                $bdd->query($sql);
                                     echo " specialite modifier"; 
