    ...
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            <h5 class="card-title text-center">Modifier Patient</h5>
            ...
            <?php
             ...
             ?>
              ...
              <div class="form-label-group">
                <?= $form->input('text','numero','Numero Dossier',$ligne['numero_dossier']);?>
              </div>

              <div class="form-label-group">
                <?= $form->input('text','nom','Nom',$ligne['nom_patient']);?>
              </div>

              <div class="form-label-group">
                <?= $form->input('text','prenom','Prénom',$ligne['prenom_patient']);?>
              </div>

              <div class="form-label-group">
              <?= $form->input('date','date','Date de Naissance',$ligne['date_de_naissance']);?>
              </div>

              <div class="form-label-group">
              <?= $form->input('text','adresse','Adresse',$ligne['adresse']);?>
              </div>

              <div class="form-label-group">
              <?= $form->input('number','telephone','TEL',$ligne['tel']);?>
              </div>

              <div class="form-label-group">
                <?= $form->input('number','cni','CNI',$ligne['cni']);?>
              </div>
                ...
                $valeur = "$numero', '$nom','$prenom', '$date','$adresse','$telephone','$cni";
                 if(empty($numero) && empty($nom) && empty($prenom) && empty($date) && empty($adresse) && empty($telephone) && empty($cni) ){
                  ...
                  echo "veuillez entrer un nom valide svp!";
                         ...
                         global $bdd;
                         $sql = "UPDATE patient SET numero_dossier='$numero', nom_patient='$nom', prenom_patient='$prenom', date_de_naissance='$date', adresse='$adresse', tel='$telephone', cni='$cni' WHERE id_patient = $id";
                         $bdd->query($sql);
